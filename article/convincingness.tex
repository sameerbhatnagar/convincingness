...
However, to our knowledge, we are among the first to propose methods that can 
distill the data from such a context and automatically assess the quality of 
...
%studies~\cite{louis_what_2013,nguyen_computational_2015} and both use a 
