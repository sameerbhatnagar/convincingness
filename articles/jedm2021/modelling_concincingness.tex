...
%It is in this light that we adopt a more pragmatic measure of argument 
%quality, 
...
\begin{itemize}
	...
	environments. 
	We demonstrate this methodology in section \ref{sec:methodology} and 
	propose evaluation metrics based on practical issues in TMPI environments;
	
	\item a comprehensive evaluation of this proposed methodology from a TMPI 
	environment, with question items from multiple disciplines. 
	...
	neural 
	transformer-based models, for the prediction of \textit{convincingness} 
	``scores''. 
	We identify some of the linguistic features most often associated with 
	high-quality student explanations in TMPI.
...
\subsection{Document Representations}\label{sec:features}
...
%	contextuality/formality measure \cite{heylighen_variation_2002},
	...
	that there are patterns that are used by students which are simpler to 
...
%	and answer choices; 
	...
	spelling errors. 
	These features have been shown to be predictive of writing quality in 
...
step, wherein the top 768 most discriminative features are retained and used as 
...
baseline to beat when modelling \textit{convincingness} in pairwise 
preference data.
