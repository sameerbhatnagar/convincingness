...
\begin{figure}
	\begin{subfigure}[t]{0.5\linewidth}
		\centering
		\scalebox{0.5}{\input{img/acc.pgf}}
	...
	\begin{subfigure}[t]{0.5\linewidth}
		\centering
		\scalebox{0.5}{\input{img/AUC.pgf}}
...
\begin{figure}
	\begin{subfigure}[t]{0.5\linewidth}
		\centering
		\scalebox{0.5}{\input{img/acc_dalite.pgf}}
	...
	\begin{subfigure}[t]{0.5\linewidth}
		\centering
		\scalebox{0.5}{\input{img/AUC_dalite.pgf}}
