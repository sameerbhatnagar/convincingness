...
\begin{table}
	\caption{Descriptive statistics for each dataset of argument pairs, with 
		last rows showing \textbf{dalite} data split by discipline. $N_{\mathrm{args}}$ 
...
\todo{If items are topics, it shows 102 in the table 2.  And the distiction between topics and items should be discussed somewhere, especially because it is critical to the two validations.}
...
ratio of $N_{\mathrm{vocab}}$ to $N_{\mathrm{args}}$ is lowest for \textbf{dalite}. 
